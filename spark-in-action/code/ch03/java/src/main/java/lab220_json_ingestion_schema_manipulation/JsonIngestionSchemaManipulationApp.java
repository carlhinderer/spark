package lab220_json_ingestion_schema_manipulation;
...
public class JsonIngestionSchemaManipulationApp {
  ...
  private void start() {
    ...
    // Reads a JSON file called Restaurants_in_Durham_County_NC.json
    String jsonFile = "/home/carl/Code/Hadoop/spark/spark-in-action/code" + 
        "/ch03/data/Restaurants_in_Durham_County_NC.json";
